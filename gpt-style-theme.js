...
(function () {
    ...
    mainStyle.textContent = `
      ...
      html:not(.dark) [data-element-id="chat-space-middle-part"] [data-element-id="user-message"] > div { font-family: ${CONFIG.fonts.primary} !important; font-size: 18px !important; line-height: 26px !important; color: ${light.text} !important; font-weight: ${CONFIG.fonts.weights.normal} !important; }
      html:not(.dark) [data-element-id="chat-space-middle-part"] .prose.max-w-full, html:not(.dark) [data-element-id="chat-space-middle-part"] [data-element-id="user-message"] { font-family: ${CONFIG.fonts.primary} !important; font-size: 18px !important; line-height: 26px !important; color: ${light.text} !important; font-weight: ${CONFIG.fonts.weights.normal} !important; -webkit-font-smoothing: antialiased !important; -moz-osx-font-smoothing: grayscale !important; text-rendering: optimizeLegibility !important; letter-spacing: -0.005em !important; }
      html:not(.dark) [data-element-id="chat-space-middle-part"] [data-element-id="user-message"] { margin-left: auto !important; margin-right: 0 !important; display: block !important; max-width: 95% !important; border-radius: ${CONFIG.borderRadius.large} !important; background-color: ${light.input.background} !important; color: ${light.text} !important; padding: ${CONFIG.spacing.medium} !important; margin-bottom: ${CONFIG.spacing.small} !important; }
      ...
      html.dark [data-element-id="chat-space-middle-part"] [data-element-id="user-message"] > div { font-family: ${CONFIG.fonts.primary} !important; font-size: 18px !important; line-height: 26px !important; color: ${dark.text} !important; font-weight: ${CONFIG.fonts.weights.normal} !important; }
      html.dark [data-element-id="chat-space-middle-part"] .prose.max-w-full, html.dark [data-element-id="chat-space-middle-part"] [data-element-id="user-message"] { font-family: ${CONFIG.fonts.primary} !important; font-size: 18px !important; line-height: 26px !important; color: ${dark.text} !important; font-weight: ${CONFIG.fonts.weights.normal} !important; -webkit-font-smoothing: antialiased !important; -moz-osx-font-smoothing: grayscale !important; text-rendering: optimizeLegibility !important; letter-spacing: -0.005em !important; }
      html.dark [data-element-id="chat-space-middle-part"] [data-element-id="user-message"] { margin-left: auto !important; margin-right: 0 !important; display: block !important; max-width: 95% !important; border-radius: ${CONFIG.borderRadius.large} !important; background-color: ${dark.input.background} !important; color: ${dark.text} !important; padding: ${CONFIG.spacing.medium} !important; margin-bottom: ${CONFIG.spacing.small} !important; }
