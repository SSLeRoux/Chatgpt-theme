...
(function () {
    ...
    mainStyle.textContent = `
      ...
      html:not(.dark) [data-element-id="chat-space-middle-part"] [data-element-id="user-message"] { margin-left: auto !important; margin-right: 0 !important; display: block !important; max-width: 100% !important; border-radius: ${CONFIG.borderRadius.large} !important; background-color: ${light.input.background} !important; color: ${light.text} !important; padding: 1.25rem 1.5rem !important; /* Top/Bottom 1.25, Left/Right 1.5 */
 !important; margin-bottom: ${CONFIG.spacing.small} !important; }
      ...
      html.dark [data-element-id="chat-space-middle-part"] [data-element-id="user-message"] { margin-left: auto !important; margin-right: 0 !important; display: block !important; max-width: 100% !important; border-radius: ${CONFIG.borderRadius.large} !important; background-color: ${dark.input.background} !important; color: ${dark.text} !important; padding: 1.25rem 1.5rem !important;
 !important; margin-bottom: ${CONFIG.spacing.small} !important; }
